...
public class Event extends NodeMultiple {
	 ...
	 */
	public int getChosenPath() { return path;}
	 ...
	 */
	public String getData() { return super.getData().toString();}
	 ...
	 */
	@Override
	public Event getDaughter(int i) { return (Event) super.getDaughter(i); }
	 ...
	 * @param i
	 */
	public void setDaughter(Event daughter, int i) { super.setDaughter(daughter,i); }
